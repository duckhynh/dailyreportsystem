...
{
    /// <inheritdoc />
    public partial class AddTaskAndRoles : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TasksDone = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Issues = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TomorrowPlan = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DailyReports_ProjectTasks_ProjectTaskId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyReports_ProjectTaskId",
                table: "DailyReports",
